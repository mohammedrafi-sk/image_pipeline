...
#ifndef IMAGE_PROC__RECTIFY_FPGA_HPP_
#define IMAGE_PROC__RECTIFY_FPGA_HPP_
...
class RectifyNodeFPGA
  : public rclcpp::Node
{
public:
  explicit RectifyNodeFPGA(const rclcpp::NodeOptions &);
...
#endif  // IMAGE_PROC__RECTIFY_FPGA_HPP_
